# Mahy Mythic Labs — YouTube Banner Style Guide
...
- Mahy Mythic Labs logo or wordmark
- Positioning line:
...
- Optional supporting themes:
  ...
  `Mythology · Ancient Civilizations · Cosmos · AI Future`

## Visual Direction

The banner should combine:

- Ancient texture or artifact detail
- A subtle cosmic horizon, star field, or celestial geometry
- Deep cinematic shadows
- One restrained warm light source
- Generous negative space around logo and positioning text

The image should feel like a portal between human history and the universe.
...
- Avoid small text, cluttered timelines, or collages of many topics.

## Recommended Structure

```text
[ atmospheric ancient/cosmic visual field ]
